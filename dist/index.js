...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (dfxVersion) {
            ...
            child_process_1.default.execSync(`DFXVM_INIT_YES=true DFX_VERSION=${dfxVersion} sh -ci "$(curl -fsSL https://sdk.dfinity.org/install.sh)" | script -e -c`);
            ...
            if (id) {
                ...
                if (dfxDisableEncryption) {
                    if (semver_1.gte(dfxVersion, "0.13.0")) {
                ...
                child_process_1.default.execSync(`${dfxPath} identity new action${disableEncryptionFlag}`);
